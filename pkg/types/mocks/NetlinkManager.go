...
func (_m *NetlinkManager) LinkAdd(link netlink.Link) error {
	ret := _m.Called(link)
...
func (_m *NetlinkManager) LinkDel(link netlink.Link) error {
	ret := _m.Called(link)
...
// SetSysVal provides a mock function with given fields: attribute, value
func (_m *NetlinkManager) SetSysVal(attribute string, value string) (string, error) {
	ret := _m.Called(attribute, value)

	var r0 string
	if rf, ok := ret.Get(0).(func(string, string) string); ok {
		r0 = rf(attribute, value)
	} else {
		r0 = ret.Get(0).(string)
	}
